								...
								<div class="form-group row">
									...
									<div class="col-sm-7">
										<input class="form-control" name="isbn" type="text"
											value="${item.isbn}" readonly="readonly"> <span class="help">Just
							...
							<div class="form-group row">
								...
								<div class="col-sm-7">
									<input class="form-control" name="blocation" type="text"
										value="${item.blocation}" readonly="readonly"><span class="help">City,
										Country.</span>
								</div>
							</div>
							<div class="form-group row">
									...
									<div class="">
										<div class="">
											<div class="row">
												...
												<div class="col-sm-7">
													<button type="button" class="btn-secondry m-r5" onclick="location.href='booklistUpdate?bid=${item.bid}'">Update</button>
												<button type="button" class="btn-secondry m-r5" onclick="location.href='booklistDelete?bid=${item.bid}'">Delete</button>
												<button type="button" class="btn-secondry m-r5" onclick="location.href='booklistMain'">Go Back</button>
												</div>
											</div>
										</div>
									</div>
