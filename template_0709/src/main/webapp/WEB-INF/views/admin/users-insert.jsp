...
<body class="ttr-opened-sidebar ttr-pinned-sidebar">
	...
	<jsp:include page="components/users-insert-main-container.jsp" flush="false" />

	<!-- External JavaScripts -->
	<jsp:include page="common-components/external-javascript.jsp" flush="false" />
</body>

<!-- Mirrored from educhamp.themetrades.com/demo/admin/users-insert.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Feb 2019 13:11:35 GMT -->
</html>