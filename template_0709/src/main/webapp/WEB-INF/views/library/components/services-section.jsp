								...
								<div class="contact-location">
									<div class="flipcard">
										<div class="front">
											<div class="top-info">
												<h3>
													<i class="fa fa-credit-card" aria-hidden="true"></i><span>Get
														a Card</span>
												</h3>
											</div>
											<div class="bottom-info">
												...
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing
													elit. Pellentesque dolor turpis.</p>
												<a href="#">View Selection <i
									...
									<div class="flipcard">
										<div class="front">
											<div class="top-info">
												<h3>
													<i class="fa fa-desktop" aria-hidden="true"></i><span>Computers
														& WiFi</span>
												</h3>
											</div>
											<div class="bottom-info">
									...
									<div class="flipcard">
										<div class="front">
											<div class="top-info">
												<h3>
													<i class="fa fa-microphone" aria-hidden="true"></i><span>Meeting
														Rooms</span>
												</h3>
											</div>
											<div class="bottom-info">
									...
									<div class="flipcard">
										<div class="front">
											<div class="top-info">
												<h3>
													<i class="fa fa-truck" aria-hidden="true"></i><span>Home
														Delivery</span>
												</h3>
											</div>
											<div class="bottom-info">
									...
									<div class="flipcard">
										<div class="front">
											<div class="top-info">
												<h3>
													<i class="fa fa-book" aria-hidden="true"></i><span>InterLibrary
														Loan</span>
												</h3>
											</div>
											<div class="bottom-info">
									...
									<div class="flipcard">
										<div class="front">
											<div class="top-info">
												<h3>
													<i class="fa fa-briefcase" aria-hidden="true"></i><span>Job
														Help</span>
												</h3>
											</div>
											<div class="bottom-info">
												...
												<div class="row">
													<div class="col-md-12">
														<div class="company-detail bg-dark margin-left">
															...
															<span class="underline left"></span>
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
																elit. Curabitur nec mauris a neque tincidunt iaculis.
																Sed tristique luctus sapien. Vestibulum arcu magna,
																ullamcorper quis porta ac, venenatis non ante.
																Pellentesque habitant morbi tristique senectus et netus
																et malesuada fames ac turpis egestas. Cras commodo
																sollicitudin felis vel porttitor. Quisque vitae egestas
													...
													<div class="col-md-12">
														<div class="company-detail bg-light margin-right">
															...
															<p>Lorem ipsum dolor sit amet, consectetur adipiscing
																...
																sollicitudin felis vel porttitor. Quisque vitae egestas
																sapien.</p>
															<a href="contact.html" class="btn btn-dark-gray">Make
																a request</a>
														</div>
													</div>
												</div>
							...
							<div class="container">
								...
								<div class="owl-carousel">
									<div class="single-testimonial-box">
										<div class="top-portion">
											...
											<div class="user-comment">
												...
												<blockquote cite="#">Lorem ipsum dolor sit
													amet, consectetur adipiscing elit. Praesent urna magna,
													rhoncus eget commodo et, dignissim non nulla. Sed sit amet
													vestibulum ex. Donec dolor velit</blockquote>
											</div>
											<div class="clear"></div>
										</div>
										<div class="bottom-portion">
											<a href="#" class="author"> Adrey Pachai <small>
													(Student )</small>
											</a>
									...
									<div class="single-testimonial-box">
										...
										<div class="bottom-portion">
											<a href="#" class="author"> Maria B <small>
													(Student )</small>
											</a>
											<div class="social-share-links">
												<ul>
