...
<html lang="zxx">
    ...
    <body>
                                                        ...
                                                        <div class="widget-inner">
                                                            <form class="edit-profile m-b30">
                                                                <div class="">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2 col-form-label">신청자</label>
                                                                        <div class="col-sm-10">
                                                                            <input class="form-control" type="text" value="">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2 col-form-label">신청자료검색</label>
                                                                        <div class="col-sm-10">
                                                                            <input class="form-control" type="text" value="">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <label class="col-sm-2 col-form-label">출판년도</label>
                                                                        <div class="col-sm-4">
                                                                            <input class="form-control" type="text" value="">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label class="col-sm-2 col-form-label">추천의견</label>
                                                                        <div class="col-sm-10">
                                                                            <textarea name="reop" cols="88" rows="7"></textarea>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-7" align="center">
                                                                                <button type="reset" class="btn">도서신청</button>
        ...
        <jsp:include page="common-components/footer-javascript.jsp" flush="false" />
